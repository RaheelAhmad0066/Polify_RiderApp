...
import 'package:poolyfi/src/driverview/views/registration%20screen/driver_registration.dart';
import 'package:sizer/sizer.dart';

import '../constants/colorconstant/colors.dart';

class SwitchToDriverScreen extends StatelessWidget {
  const SwitchToDriverScreen({Key? key}) : super(key: key);
