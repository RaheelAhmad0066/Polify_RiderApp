...
import 'package:poolyfi/src/driverview/views/Notification%20screen/driver_notification_screen.dart';
import 'package:poolyfi/src/driverview/views/home%20screen/driverhome.dart';
import 'package:poolyfi/src/driverview/views/my%20rides/my_rides.dart';
import 'package:poolyfi/src/driverview/views/reviews/driver_reviews.dart';
import 'package:poolyfi/src/driverview/views/switch%20to%20passenger/switch_passenger.dart';
import 'package:poolyfi/src/driverview/views/wallet%20screen/wallet_screen.dart';
...
class DriverDrawerScreen extends StatefulWidget {
  const DriverDrawerScreen({Key? key}) : super(key: key);
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => DriverWalletScreen()));
              },
            ),
            ListTile(
              leading: Icon(
              ...
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: ((context) => MyRides())));
              },
            ),
            ListTile(
              leading: Icon(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => ModeSetting()));
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: ((context) => DriverNotificationScreen())));
              },
            ),
            ListTile(
              leading: Icon(
              ...
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: ((context) => DriverReviews())));
              },
            ),
            ListTile(
              leading: Icon(
                  ...
                  onPressed: () {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SwitchToPassengerScreen()));
                    });
                  },
                  color: Color(AppColorConst.yellow),
